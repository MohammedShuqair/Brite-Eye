...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/doctor_fill.svg
  SvgGenImage get doctorFill =>
      const SvgGenImage('assets/icons/doctor_fill.svg');
  ...
  /// List of all assets
  List<dynamic> get values => [doctor, doctorFill, logo, report];
}
